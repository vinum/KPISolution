...
router.get('/home2', (req: express.Request, res: express.Response) => {
    var message = '';
    res.render('home2');
...
router.get('/availability', (req: express.Request, res: express.Response) => {
    //var message = '';
...
router.get('/quality', (req: express.Request, res: express.Response) => {
    //var message = '';
...
router.get('/speak/:name', (req: express.Request, res: express.Response) => {
...
router.get('/repeat/:message/:id', (req: express.Request, res: express.Response) => {
